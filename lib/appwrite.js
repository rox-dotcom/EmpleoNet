...
import {ENDPOINT_APPWRITE, PLATFORM, PROJECT_ID, DB_ID, USER_COLLECTON_ID, SERVICE_COLLECTION, VENDEDOR_COLLECTION,SERVICE_HISTORY_ID,STORAGE_ID} from '@env'
...
export const config = {
    ...
    databaseId: DB_ID,
    userCollectionId: USER_COLLECTON_ID,
  ...
  try {
    ...
    const posts = await databases.listDocuments(
      ...
      const services = await Promise.all(
        serviceHistoryId.documents.map(async (history) => {
