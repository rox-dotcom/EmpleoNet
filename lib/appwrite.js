...
import {ENDPOINT_APPWRITE, PLATFORM, PROJECT_ID, DB_ID, USER_COLLECTON, SERVICE_COLLECTION, VENDEDOR_COLLECTION,SERVICE_HISTORY_ID,STORAGE_ID} from '@env'
...
export const config = {
    ...
    databaseId: DB_ID,
    userCollectionId: USER_COLLECTON,
